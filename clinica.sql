...
--
-- Host: 127.0.0.1
-- Generation Time: 17-Fev-2016 às 14:16
...
INSERT INTO `user` (`Nome`, `Email`, `Idade`, `Sexo`, `Username`, `Password`, `Tipo`) VALUES
('ola', 'sdkhfgasdk@hotmail.com', 11, 'masculino', 'ola', '123', ''),
('we', 'simaoeduardo773@gmail.com', 11, 'we', '123', '123', '');
